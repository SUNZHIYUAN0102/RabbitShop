  ...
  <div class="order-item">
    <div class="head">
      ...
      <span v-if="order.orderState === 1" class="down-time">
        ...
        <b v-if="order.countdown > 0">付款截止：{{ timeText }}</b>
        <b v-else>付款截止：{{ order.payLatestTime }}</b>
      </span>
      <a
    ...
    <div class="body">
      <div class="column goods">
        <ul>
          <li v-for="goods in order.skus" :key="goods.id">
            ...
            <div class="count">{{ goods.quantity }}</div>
          </li>
        </ul>
      </div>
      ...
      <div class="column action">
        <xtx-button
          ...
          >立即付款</xtx-button
        >
        <xtx-button v-if="order.orderState === 3" type="primary" size="small"
          >确认收货</xtx-button
        >
        <p>
          <a
